...
const copy = {
  sk: {
    ...
    metaTitle: '[Vaše meno] | Energetická hospodárnosť budov', metaDescription: 'Nezávislý konzultant pre energetické certifikáty, hodnotenie budov, energetickú efektívnosť a technickú dokumentáciu.',
  },
  en: {
  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        <a className="brand" href="#home" onClick={closeMenu} aria-label="[Vaše meno] domov">
          <span className="brand-mark"><Building2 size={24} strokeWidth={1.8} /></span>
          <span><strong>[VAŠE MENO]</strong><small>{t.role}</small></span>
        </a>
      ...
      <footer>
        <a className="brand footer-brand" href="#home"><span className="brand-mark"><Building2 size={24} strokeWidth={1.8} /></span><span><strong>[VAŠE MENO]</strong><small>{t.role}</small></span></a>
        <p>{t.footer}</p><span>© 2026 [Vaše meno]. {t.rights}</span>
      </footer>
    </div>
  )
}
